...
import UpgradeRequiredErrorPage from '../../pages/UpgradeRequiredErrorPage';
...
describe('UpgradeRequiredErrorPage', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  ...
  it('renders upgrade required error page correctly', () => {
    render(
      <TestWrapper>
        <UpgradeRequiredErrorPage />
      </TestWrapper>
    );

    expect(screen.getByText('Upgrade Required')).toBeInTheDocument();
    expect(screen.getByText('The client must upgrade to a newer version')).toBeInTheDocument();
  });
  ...
  it('displays troubleshooting steps', () => {
    ...
    expect(screen.getByText('Check client version')).toBeInTheDocument();
    expect(screen.getByText('Verify server requirements')).toBeInTheDocument();
    expect(screen.getByText('Check compatibility matrix')).toBeInTheDocument();
  ...
  it('displays error code', () => {
    ...
    expect(screen.getByText('UPGRADE_REQUIRED_ERROR')).toBeInTheDocument();
  });
