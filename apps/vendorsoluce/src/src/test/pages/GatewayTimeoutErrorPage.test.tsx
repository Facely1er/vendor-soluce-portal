...
import GatewayTimeoutErrorPage from '../../pages/GatewayTimeoutErrorPage';
...
describe('GatewayTimeoutErrorPage', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  ...
  it('renders gateway timeout error page correctly', () => {
    render(
      <TestWrapper>
    ...
    expect(screen.getByText('The gateway did not receive a timely response from the upstream server')).toBeInTheDocument();
  });
  ...
  it('displays troubleshooting steps', () => {
    ...
    expect(screen.getByText('Verify gateway timeout settings')).toBeInTheDocument();
  ...
  it('displays error code', () => {
    ...
    expect(screen.getByText('GATEWAY_TIMEOUT_ERROR')).toBeInTheDocument();
  });
