...
import NotExtendedErrorPage from '../../pages/NotExtendedErrorPage';
...
describe('NotExtendedErrorPage', () => {
  ...
  it('renders not extended error page correctly', () => {
    render(
      <TestWrapper>
        <NotExtendedErrorPage />
      </TestWrapper>
    );

    expect(screen.getByText('Not Extended')).toBeInTheDocument();
    expect(screen.getByText('The server does not support the extension required for the request')).toBeInTheDocument();
  });
  ...
  it('displays troubleshooting steps', () => {
    ...
    expect(screen.getByText('Check extension support')).toBeInTheDocument();
    expect(screen.getByText('Verify server capabilities')).toBeInTheDocument();
    expect(screen.getByText('Check extension configuration')).toBeInTheDocument();
  ...
  it('displays error code', () => {
    ...
    expect(screen.getByText('NOT_EXTENDED_ERROR')).toBeInTheDocument();
  });
