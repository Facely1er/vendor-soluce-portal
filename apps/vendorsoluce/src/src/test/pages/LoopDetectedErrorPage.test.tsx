...
import LoopDetectedErrorPage from '../../pages/LoopDetectedErrorPage';
...
describe('LoopDetectedErrorPage', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  ...
  it('renders loop detected error page correctly', () => {
    render(
      <TestWrapper>
        <LoopDetectedErrorPage />
      </TestWrapper>
    );

    expect(screen.getByText('Loop Detected')).toBeInTheDocument();
    expect(screen.getByText('The server detected an infinite loop while processing the request')).toBeInTheDocument();
  });
  ...
  it('displays troubleshooting steps', () => {
    ...
    expect(screen.getByText('Check request processing logic')).toBeInTheDocument();
    expect(screen.getByText('Verify loop detection settings')).toBeInTheDocument();
  ...
  it('displays error code', () => {
    ...
    expect(screen.getByText('LOOP_DETECTED_ERROR')).toBeInTheDocument();
  });
