...
import InternalServerErrorErrorPage from '../../pages/InternalServerErrorErrorPage';
...
describe('InternalServerErrorErrorPage', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  ...
  it('renders internal server error error page correctly', () => {
    render(
      <TestWrapper>
        <InternalServerErrorErrorPage />
      </TestWrapper>
    );
  ...
  it('displays error code', () => {
    ...
    expect(screen.getByText('INTERNAL_SERVER_ERROR_ERROR')).toBeInTheDocument();
  });
