...
describe('GatewayTimeoutPage', () => {
  ...
  it('renders gateway timeout page correctly', () => {
    render(
      <TestWrapper>
        <GatewayTimeoutPage />
      </TestWrapper>
    ...
    expect(screen.getByText('The server did not receive a timely response from an upstream server')).toBeInTheDocument();
  });
