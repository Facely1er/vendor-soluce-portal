...
describe('NotFoundErrorPage', () => {
  ...
  it('displays error code', () => {
    ...
    expect(screen.getByText('NOT_FOUND_ERROR')).toBeInTheDocument();
  });
  ...
  it('displays error prevention tips', () => {
    ...
    expect(screen.getByText('Double-check URLs before clicking')).toBeInTheDocument();
    expect(screen.getByText('Use bookmarks for important pages')).toBeInTheDocument();
    expect(screen.getByText('Keep track of page navigation')).toBeInTheDocument();
  });
