...
describe('BadRequestErrorPage', () => {
  ...
  it('renders bad request error page correctly', () => {
    render(
      <TestWrapper>
        <BadRequestErrorPage />
      </TestWrapper>
    ...
    expect(screen.getByText('The request was invalid or cannot be served')).toBeInTheDocument();
  });
  ...
  it('displays troubleshooting steps', () => {
    ...
    expect(screen.getByText('Check your input data')).toBeInTheDocument();
    ...
    expect(screen.getByText('Try again with corrected data')).toBeInTheDocument();
  });
  ...
  it('displays error code', () => {
    ...
    expect(screen.getByText('BAD_REQUEST_ERROR')).toBeInTheDocument();
  });
  ...
  it('displays error prevention tips', () => {
    ...
    expect(screen.getByText('Validate data before submission')).toBeInTheDocument();
    expect(screen.getByText('Follow request format requirements')).toBeInTheDocument();
    expect(screen.getByText('Ensure data consistency')).toBeInTheDocument();
  });
