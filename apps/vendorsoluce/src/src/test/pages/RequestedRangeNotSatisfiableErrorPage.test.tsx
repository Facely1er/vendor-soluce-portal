...
import RequestedRangeNotSatisfiableErrorPage from '../../pages/RequestedRangeNotSatisfiableErrorPage';
...
describe('RequestedRangeNotSatisfiableErrorPage', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  ...
  it('renders requested range not satisfiable error page correctly', () => {
    render(
      <TestWrapper>
        <RequestedRangeNotSatisfiableErrorPage />
      </TestWrapper>
    );

    expect(screen.getByText('Requested Range Not Satisfiable')).toBeInTheDocument();
    expect(screen.getByText('The requested range cannot be satisfied')).toBeInTheDocument();
  });
  ...
  it('displays troubleshooting steps', () => {
    ...
    expect(screen.getByText('Check range parameters')).toBeInTheDocument();
    expect(screen.getByText('Verify resource size')).toBeInTheDocument();
    expect(screen.getByText('Use valid range values')).toBeInTheDocument();
  ...
  it('displays error code', () => {
    ...
    expect(screen.getByText('REQUESTED_RANGE_NOT_SATISFIABLE_ERROR')).toBeInTheDocument();
  });
