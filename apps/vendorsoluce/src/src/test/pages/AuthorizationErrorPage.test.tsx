...
import AuthorizationErrorPage from '../../pages/AuthorizationErrorPage';
...
describe('AuthorizationErrorPage', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  ...
  it('renders authorization error page correctly', () => {
    render(
      <TestWrapper>
  ...
  it('displays troubleshooting steps', () => {
    ...
    expect(screen.getByText('Check your account permissions')).toBeInTheDocument();
    expect(screen.getByText('Verify your role level')).toBeInTheDocument();
  ...
  it('displays error code', () => {
    ...
    expect(screen.getByText('AUTHZ_ERROR')).toBeInTheDocument();
  });
