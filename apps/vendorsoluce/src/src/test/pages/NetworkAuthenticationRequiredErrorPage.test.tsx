...
import NetworkAuthenticationRequiredErrorPage from '../../pages/NetworkAuthenticationRequiredErrorPage';
...
describe('NetworkAuthenticationRequiredErrorPage', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  ...
  it('renders network authentication required error page correctly', () => {
    render(
      <TestWrapper>
        <NetworkAuthenticationRequiredErrorPage />
      </TestWrapper>
    );

    expect(screen.getByText('Network Authentication Required')).toBeInTheDocument();
    expect(screen.getByText('The client must authenticate with the network to access the resource')).toBeInTheDocument();
  });
  ...
  it('displays troubleshooting steps', () => {
    ...
    expect(screen.getByText('Check network authentication')).toBeInTheDocument();
    expect(screen.getByText('Verify network credentials')).toBeInTheDocument();
    expect(screen.getByText('Check network configuration')).toBeInTheDocument();
    expect(screen.getByText('Contact network administrator')).toBeInTheDocument();
  });
  ...
  it('displays error code', () => {
    ...
    expect(screen.getByText('NETWORK_AUTHENTICATION_REQUIRED_ERROR')).toBeInTheDocument();
  });
