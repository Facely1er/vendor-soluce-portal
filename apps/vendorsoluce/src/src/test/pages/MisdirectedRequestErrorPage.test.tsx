...
import MisdirectedRequestErrorPage from '../../pages/MisdirectedRequestErrorPage';
...
describe('MisdirectedRequestErrorPage', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  ...
  it('renders misdirected request error page correctly', () => {
    render(
      <TestWrapper>
        <MisdirectedRequestErrorPage />
      </TestWrapper>
    );

    expect(screen.getByText('Misdirected Request')).toBeInTheDocument();
    expect(screen.getByText('The request was directed to the wrong server')).toBeInTheDocument();
  });
  ...
  it('displays troubleshooting steps', () => {
    ...
    expect(screen.getByText('Verify request routing')).toBeInTheDocument();
    expect(screen.getByText('Check proxy settings')).toBeInTheDocument();
  ...
  it('displays error code', () => {
    ...
    expect(screen.getByText('MISDIRECTED_REQUEST_ERROR')).toBeInTheDocument();
  });
