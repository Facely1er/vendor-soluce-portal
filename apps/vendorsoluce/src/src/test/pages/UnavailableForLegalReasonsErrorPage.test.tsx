...
import UnavailableForLegalReasonsErrorPage from '../../pages/UnavailableForLegalReasonsErrorPage';
...
describe('UnavailableForLegalReasonsErrorPage', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  ...
  it('renders unavailable for legal reasons error page correctly', () => {
    render(
      <TestWrapper>
        <UnavailableForLegalReasonsErrorPage />
      </TestWrapper>
    );

    expect(screen.getByText('Unavailable For Legal Reasons')).toBeInTheDocument();
    expect(screen.getByText('The resource is unavailable due to legal restrictions')).toBeInTheDocument();
  });
  ...
  it('displays troubleshooting steps', () => {
    ...
    expect(screen.getByText('Check legal restrictions')).toBeInTheDocument();
    expect(screen.getByText('Verify compliance status')).toBeInTheDocument();
    expect(screen.getByText('Check jurisdiction rules')).toBeInTheDocument();
    expect(screen.getByText('Contact legal department')).toBeInTheDocument();
  });
  ...
  it('displays error code', () => {
    ...
    expect(screen.getByText('UNAVAILABLE_FOR_LEGAL_REASONS_ERROR')).toBeInTheDocument();
  });
