...
import PreconditionFailedErrorPage from '../../pages/PreconditionFailedErrorPage';
...
describe('PreconditionFailedErrorPage', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  ...
  it('renders precondition failed error page correctly', () => {
    render(
      <TestWrapper>
        <PreconditionFailedErrorPage />
      </TestWrapper>
    );

    expect(screen.getByText('Precondition Failed')).toBeInTheDocument();
    expect(screen.getByText('The request precondition failed')).toBeInTheDocument();
  });
  ...
  it('displays troubleshooting steps', () => {
    ...
    expect(screen.getByText('Check request preconditions')).toBeInTheDocument();
    expect(screen.getByText('Verify resource state')).toBeInTheDocument();
    expect(screen.getByText('Ensure data consistency')).toBeInTheDocument();
  ...
  it('displays error code', () => {
    ...
    expect(screen.getByText('PRECONDITION_FAILED_ERROR')).toBeInTheDocument();
  });
  ...
  it('displays error prevention tips', () => {
    ...
    expect(screen.getByText('Check resource state before requests')).toBeInTheDocument();
    expect(screen.getByText('Verify preconditions')).toBeInTheDocument();
    expect(screen.getByText('Ensure data consistency')).toBeInTheDocument();
  });
