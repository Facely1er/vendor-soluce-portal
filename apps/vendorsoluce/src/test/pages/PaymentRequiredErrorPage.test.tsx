...
import PaymentRequiredErrorPage from '../../pages/PaymentRequiredErrorPage';
...
describe('PaymentRequiredErrorPage', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  ...
  it('renders payment required error page correctly', () => {
    render(
      <TestWrapper>
        <PaymentRequiredErrorPage />
      </TestWrapper>
    );

    expect(screen.getByText('Payment Required')).toBeInTheDocument();
    expect(screen.getByText('Payment is required to access this resource')).toBeInTheDocument();
  });
  ...
  it('displays troubleshooting steps', () => {
    ...
    expect(screen.getByText('Check your payment status')).toBeInTheDocument();
    expect(screen.getByText('Update your payment method')).toBeInTheDocument();
    expect(screen.getByText('Contact billing support')).toBeInTheDocument();
    expect(screen.getByText('Try again after payment')).toBeInTheDocument();
  });
  ...
  it('displays error code', () => {
    ...
    expect(screen.getByText('PAYMENT_REQUIRED_ERROR')).toBeInTheDocument();
  });
  ...
  it('displays error prevention tips', () => {
    ...
    expect(screen.getByText('Keep your payment method updated')).toBeInTheDocument();
    expect(screen.getByText('Monitor your billing status')).toBeInTheDocument();
