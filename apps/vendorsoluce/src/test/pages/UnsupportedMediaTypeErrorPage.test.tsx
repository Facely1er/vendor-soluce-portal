...
import UnsupportedMediaTypeErrorPage from '../../pages/UnsupportedMediaTypeErrorPage';
...
describe('UnsupportedMediaTypeErrorPage', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  ...
  it('renders unsupported media type error page correctly', () => {
    render(
      <TestWrapper>
        <UnsupportedMediaTypeErrorPage />
      </TestWrapper>
    );

    expect(screen.getByText('Unsupported Media Type')).toBeInTheDocument();
    expect(screen.getByText('The media type is not supported')).toBeInTheDocument();
  });
  ...
  it('displays troubleshooting steps', () => {
    ...
    expect(screen.getByText('Check file format')).toBeInTheDocument();
    expect(screen.getByText('Use supported media types')).toBeInTheDocument();
    expect(screen.getByText('Convert to supported format')).toBeInTheDocument();
  ...
  it('displays error code', () => {
    ...
    expect(screen.getByText('UNSUPPORTED_MEDIA_TYPE_ERROR')).toBeInTheDocument();
  });
  ...
  it('displays error prevention tips', () => {
    ...
    expect(screen.getByText('Check supported file formats')).toBeInTheDocument();
    expect(screen.getByText('Use standard media types')).toBeInTheDocument();
    expect(screen.getByText('Convert files to supported formats')).toBeInTheDocument();
  });
