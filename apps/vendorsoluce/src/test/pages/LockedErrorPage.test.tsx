...
import LockedErrorPage from '../../pages/LockedErrorPage';
...
describe('LockedErrorPage', () => {
  ...
  it('renders locked error page correctly', () => {
    render(
      <TestWrapper>
        <LockedErrorPage />
      </TestWrapper>
    ...
    expect(screen.getByText('The resource is locked and cannot be accessed')).toBeInTheDocument();
  });
  ...
  it('displays troubleshooting steps', () => {
    ...
    expect(screen.getByText('Verify access permissions')).toBeInTheDocument();
    expect(screen.getByText('Check for active locks')).toBeInTheDocument();
    expect(screen.getByText('Contact resource administrator')).toBeInTheDocument();
  });
  ...
  it('displays error code', () => {
    ...
    expect(screen.getByText('LOCKED_ERROR')).toBeInTheDocument();
  });
