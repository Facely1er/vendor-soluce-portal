...
import HttpVersionNotSupportedErrorPage from '../../pages/HttpVersionNotSupportedErrorPage';
...
describe('HttpVersionNotSupportedErrorPage', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  ...
  it('renders HTTP version not supported error page correctly', () => {
    render(
      <TestWrapper>
        <HttpVersionNotSupportedErrorPage />
      </TestWrapper>
    );

    expect(screen.getByText('HTTP Version Not Supported')).toBeInTheDocument();
    expect(screen.getByText('The HTTP version used in the request is not supported')).toBeInTheDocument();
  });
  ...
  it('displays troubleshooting steps', () => {
    ...
    expect(screen.getByText('Check HTTP version compatibility')).toBeInTheDocument();
    expect(screen.getByText('Verify client configuration')).toBeInTheDocument();
  ...
  it('displays error code', () => {
    ...
    expect(screen.getByText('HTTP_VERSION_NOT_SUPPORTED_ERROR')).toBeInTheDocument();
  });
