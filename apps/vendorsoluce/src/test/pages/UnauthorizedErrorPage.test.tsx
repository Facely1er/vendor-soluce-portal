...
describe('UnauthorizedErrorPage', () => {
  ...
  it('renders unauthorized error page correctly', () => {
    render(
      <TestWrapper>
    ...
    expect(screen.getByText('You are not authorized to access this resource')).toBeInTheDocument();
  });
  ...
  it('displays troubleshooting steps', () => {
    ...
    expect(screen.getByText('Check your login status')).toBeInTheDocument();
  ...
  it('displays error code', () => {
    ...
    expect(screen.getByText('UNAUTHORIZED_ERROR')).toBeInTheDocument();
  });
  ...
  it('displays error prevention tips', () => {
    ...
    expect(screen.getByText('Keep your login credentials secure')).toBeInTheDocument();
