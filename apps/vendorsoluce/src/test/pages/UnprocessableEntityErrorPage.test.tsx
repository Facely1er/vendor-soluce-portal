...
import UnprocessableEntityErrorPage from '../../pages/UnprocessableEntityErrorPage';
...
describe('UnprocessableEntityErrorPage', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  ...
  it('renders unprocessable entity error page correctly', () => {
    render(
      <TestWrapper>
        <UnprocessableEntityErrorPage />
      </TestWrapper>
    );

    expect(screen.getByText('Unprocessable Entity')).toBeInTheDocument();
    expect(screen.getByText('The request was well-formed but contains semantic errors')).toBeInTheDocument();
  });
  ...
  it('displays troubleshooting steps', () => {
    ...
    expect(screen.getByText('Check request data format')).toBeInTheDocument();
    expect(screen.getByText('Verify field validation')).toBeInTheDocument();
    expect(screen.getByText('Check business logic rules')).toBeInTheDocument();
  ...
  it('displays error code', () => {
    ...
    expect(screen.getByText('UNPROCESSABLE_ENTITY_ERROR')).toBeInTheDocument();
  });
