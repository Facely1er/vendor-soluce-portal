...
import VariantAlsoNegotiatesErrorPage from '../../pages/VariantAlsoNegotiatesErrorPage';
...
describe('VariantAlsoNegotiatesErrorPage', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  ...
  it('renders variant also negotiates error page correctly', () => {
    render(
      <TestWrapper>
        <VariantAlsoNegotiatesErrorPage />
      </TestWrapper>
    );

    expect(screen.getByText('Variant Also Negotiates')).toBeInTheDocument();
    expect(screen.getByText('The server has a configuration error in content negotiation')).toBeInTheDocument();
  });
  ...
  it('displays troubleshooting steps', () => {
    ...
    expect(screen.getByText('Check content negotiation configuration')).toBeInTheDocument();
    expect(screen.getByText('Verify variant settings')).toBeInTheDocument();
    expect(screen.getByText('Check server configuration')).toBeInTheDocument();
  ...
  it('displays error code', () => {
    ...
    expect(screen.getByText('VARIANT_ALSO_NEGOTIATES_ERROR')).toBeInTheDocument();
  });
