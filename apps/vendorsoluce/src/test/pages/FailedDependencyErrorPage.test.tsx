...
import FailedDependencyErrorPage from '../../pages/FailedDependencyErrorPage';
...
describe('FailedDependencyErrorPage', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  ...
  it('renders failed dependency error page correctly', () => {
    render(
      <TestWrapper>
        <FailedDependencyErrorPage />
      </TestWrapper>
    );

    expect(screen.getByText('Failed Dependency')).toBeInTheDocument();
    expect(screen.getByText('The request failed due to a failed dependency')).toBeInTheDocument();
  });
  ...
  it('displays troubleshooting steps', () => {
    ...
    expect(screen.getByText('Check dependency status')).toBeInTheDocument();
    expect(screen.getByText('Verify dependency configuration')).toBeInTheDocument();
    expect(screen.getByText('Check dependency connectivity')).toBeInTheDocument();
    expect(screen.getByText('Contact dependency administrator')).toBeInTheDocument();
  });
  ...
  it('displays error code', () => {
    ...
    expect(screen.getByText('FAILED_DEPENDENCY_ERROR')).toBeInTheDocument();
  });
