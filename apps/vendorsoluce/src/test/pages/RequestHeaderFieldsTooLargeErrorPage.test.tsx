...
import RequestHeaderFieldsTooLargeErrorPage from '../../pages/RequestHeaderFieldsTooLargeErrorPage';
...
describe('RequestHeaderFieldsTooLargeErrorPage', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  ...
  it('renders request header fields too large error page correctly', () => {
    render(
      <TestWrapper>
        <RequestHeaderFieldsTooLargeErrorPage />
      </TestWrapper>
    );

    expect(screen.getByText('Request Header Fields Too Large')).toBeInTheDocument();
    expect(screen.getByText('The request header fields are too large')).toBeInTheDocument();
  });
  ...
  it('displays troubleshooting steps', () => {
    ...
    expect(screen.getByText('Check header size limits')).toBeInTheDocument();
    expect(screen.getByText('Verify header configuration')).toBeInTheDocument();
    expect(screen.getByText('Check header compression')).toBeInTheDocument();
  ...
  it('displays error code', () => {
    ...
    expect(screen.getByText('REQUEST_HEADER_FIELDS_TOO_LARGE_ERROR')).toBeInTheDocument();
  });
