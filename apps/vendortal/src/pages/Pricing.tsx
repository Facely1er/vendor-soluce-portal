...
const Pricing: React.FC = () => {
  ...
  logger.info('Billing interval mapping:', { isAnnual, billingInterval });
  ...
  // const getSavingsAmount = (monthlyPrice: number, annualPrice: number) => {
  //   const monthlyTotal = monthlyPrice * 12;
          ...
          <Card className="max-w-2xl mx-auto mb-8 bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 border-green-200 dark:border-green-700">
            <CardContent className="p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-lg p-4">
                  <div className="text-2xl font-bold text-gray-900 dark:text-white">$310</div>
                  <div className="text-sm text-gray-600 dark:text-gray-400">Professional Annual Savings</div>
                </div>
                <div className="bg-white dark:bg-gray-800 rounded-lg p-4">
                  <div className="text-2xl font-bold text-gray-900 dark:text-white">$956</div>
      ...
      <div className="mb-16">
        ...
        {mainProducts.length === 0 ? (
          <div className="text-center text-red-500">
            ...
            <p>Debug info: {JSON.stringify({ isAnnual, billingInterval, mainProductsCount: mainProducts.length })}</p>
          </div>
        ) : (
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                ...
                <tbody className="bg-white dark:bg-gray-900 divide-y divide-gray-200 dark:divide-gray-700">
                  {[
                    { feature: 'Team Members', starter: '5', professional: '25', enterprise: 'Unlimited', federal: 'Unlimited' },
                    { feature: 'Quick Assessment (Free)', starter: '✓ 3/month', professional: '✓ Unlimited', enterprise: '✓ Unlimited', federal: '✓ Unlimited' },
                    { feature: 'Standard Assessment', starter: '✗', professional: '✓', enterprise: '✓', federal: '✓' },
                    { feature: 'Comprehensive Assessment', starter: '✗', professional: '✗', enterprise: '✓', federal: '✓' },
                    { feature: 'Risk Radar Dashboard', starter: '✓', professional: '✓', enterprise: '✓', federal: '✓' },
                    { feature: 'NIST SP 800-161 Assessment', starter: '✓', professional: '✓', enterprise: '✓', federal: '✓' },
                    { feature: 'Storage', starter: '1GB', professional: '10GB', enterprise: '100GB', federal: '1TB' },
                    { feature: 'CMMC 2.0', starter: '✗', professional: '✓', enterprise: '✓', federal: '✓' },
                    { feature: 'SOC2 Support', starter: '✗', professional: '✗', enterprise: '✓', federal: '✗' },
                    { feature: 'ISO 27001 Support', starter: '✗', professional: '✗', enterprise: '✓', federal: '✗' },
                    { feature: 'FedRAMP Support', starter: '✗', professional: '✗', enterprise: '✓', federal: '✓' },
                    { feature: 'FISMA Support', starter: '✗', professional: '✗', enterprise: '✓', federal: '✓' },
                    { feature: 'API Access', starter: '✗', professional: '✓', enterprise: '✓', federal: '✓' },
                    { feature: 'White-Label', starter: '✗', professional: '✓', enterprise: '✓', federal: '✓' },
                    { feature: 'SSO/SAML', starter: '✗', professional: '✗', enterprise: '✓', federal: '✓' },
                    { feature: 'Custom Integrations', starter: '✗', professional: '✗', enterprise: '✓', federal: '✓' },
                    { feature: 'Dedicated Support', starter: '✗', professional: '✗', enterprise: '✓', federal: '✓' },
                    { feature: 'SLA Support', starter: '✗', professional: '✗', enterprise: '✓', federal: '✓' }
                  ].map((row, index) => (
