  ...
  return (
    <main className="min-h-screen bg-gray-50 dark:bg-gray-900 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        {/* Demo Banner */}
        <div className="mb-8 bg-gradient-to-r from-vendortal-navy to-vendortal-purple text-white rounded-lg p-6">
          <div className="flex flex-col md:flex-row items-center justify-between">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <Link to="/signup">
                <Button variant="secondary" size="lg" className="bg-white text-vendortal-navy hover:bg-gray-100">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          {demoMetrics.map((metric, index) => (
            <Card key={index} className="relative overflow-hidden">
              ...
              <div className="absolute top-0 right-0 w-16 h-16 bg-gradient-to-br from-vendortal-purple/10 to-vendortal-light-purple/10 rounded-bl-full"></div>
            </Card>
          ))}
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center">
                  <BarChart3 className="h-5 w-5 mr-2 text-vendortal-purple" />
                  Risk Distribution
                </CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center">
                  <Zap className="h-5 w-5 mr-2 text-vendortal-purple" />
                  Quick Actions
                </CardTitle>
              </CardHeader>
              <CardContent>
          ...
          <div className="lg:col-span-1 space-y-6">
            {/* Sign In Prompt */}
            <Card className="border-l-4 border-l-vendortal-purple">
              <CardContent className="p-6">
                <div className="text-center">
                  <Lock className="h-12 w-12 text-vendortal-purple mx-auto mb-4" />
            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center">
                  <Activity className="h-5 w-5 mr-2 text-vendortal-purple" />
                  Recent Activity
        ...
        <div className="mt-12">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6 text-center">
            What you get with a VendorTal account
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card className="text-center p-6">
              <div className="w-12 h-12 bg-vendortal-purple/10 rounded-full flex items-center justify-center mx-auto mb-4">
                <BarChart3 className="h-6 w-6 text-vendortal-purple" />
              </div>
            ...
            <Card className="text-center p-6">
              <div className="w-12 h-12 bg-vendortal-purple/10 rounded-full flex items-center justify-center mx-auto mb-4">
                <Shield className="h-6 w-6 text-vendortal-purple" />
              </div>
            ...
            <Card className="text-center p-6">
              <div className="w-12 h-12 bg-vendortal-purple/10 rounded-full flex items-center justify-center mx-auto mb-4">
                <TrendingUp className="h-6 w-6 text-vendortal-purple" />
              </div>
        ...
        {/* CTA Section */}
        <div className="mt-12 bg-gradient-to-r from-vendortal-purple to-vendortal-light-purple text-white rounded-lg p-8 text-center">
          ...
          <p className="text-xl text-gray-100 mb-6 max-w-2xl mx-auto">
            Join organizations using VendorTal to manage supply chain risks and ensure compliance
          </p>
