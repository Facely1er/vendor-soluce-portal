        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-300">
              Track your actions and system events across VendorTal
            </p>
          </div>
          ...
          {filteredActivities.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                {searchTerm ? 'Try adjusting your search terms' : 'Your activity will appear here as you use VendorTal'}
              </p>
            </div>
          ) : (
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center">
              <div className="text-2xl font-bold text-vendortal-purple mb-2">
