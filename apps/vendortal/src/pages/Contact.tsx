...
const Contact: React.FC = () => {
  ...
  return (
    <main className="min-h-screen py-8 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
                  ...
                  <div className="mb-6">
                    <div className="flex items-start">
                      ...
                      <label htmlFor="terms" className="ml-2 text-sm text-gray-600 dark:text-gray-400">
                        {t('contact.form.fields.termsPrefix')} <Link to="/privacy" className="text-vendortal-navy dark:text-vendortal-purple hover:underline">{t('contact.form.fields.privacyPolicy')}</Link> and <Link to="/terms" className="text-vendortal-navy dark:text-vendortal-purple hover:underline">{t('contact.form.fields.terms')}</Link>
                      </label>
                    </div>
                  </div>
        ...
        <div>
          <Card className="p-6 mb-6">
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                <Mail className="h-5 w-5 text-vendortal-navy dark:text-vendortal-purple mr-3 mt-0.5" />
                <div>
                  <p className="text-sm font-medium text-gray-900 dark:text-white">{t('contact.info.email.label')}</p>
                  <a href="mailto:contact@ermits.com" className="text-gray-600 dark:text-gray-300 hover:text-vendortal-navy dark:hover:text-vendortal-purple">
              ...
              <li className="flex items-start">
                <Phone className="h-5 w-5 text-vendortal-navy dark:text-vendortal-purple mr-3 mt-0.5" />
                <div>
                  <p className="text-sm font-medium text-gray-900 dark:text-white">{t('contact.info.phone.label')}</p>
                  <a href="tel:+18886186160" className="text-gray-600 dark:text-gray-300 hover:text-vendortal-navy dark:hover:text-vendortal-purple">
              ...
              <li className="flex items-start">
                <MapPin className="h-5 w-5 text-vendortal-navy dark:text-vendortal-purple mr-3 mt-0.5" />
                <div>
              ...
              <li className="flex items-start">
                <Clock className="h-5 w-5 text-vendortal-navy dark:text-vendortal-purple mr-3 mt-0.5" />
                <div>
          ...
          <Card className="p-6">
            ...
            <div className="flex items-center mb-4">
              <MessageSquare className="h-5 w-5 text-vendortal-purple mr-2" />
      ...
      <section className="bg-gradient-to-r from-vendortal-navy to-vendortal-purple text-white rounded-lg overflow-hidden">
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button 
                ...
                onClick={() => window.location.href = '/vendor-assessments'}
              >
