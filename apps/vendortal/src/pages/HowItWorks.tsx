...
const HowItWorks: React.FC = () => {
  ...
  const steps = [
    {
      id: 1,
      title: t('howItWorks.steps.send.title'),
      description: t('howItWorks.steps.send.description'),
      icon: <ClipboardCheck className="h-12 w-12 text-vendortal-purple" />,
      features: [
        t('howItWorks.steps.send.features.templates'),
        t('howItWorks.steps.send.features.automation'),
        t('howItWorks.steps.send.features.tracking'),
        t('howItWorks.steps.send.features.notifications')
      ],
      ctaText: t('howItWorks.steps.send.cta'),
      ctaLink: '/vendor-assessments',
      gradient: 'from-vendortal-purple to-vendortal-light-purple',
      visualElements: {
    ...
    {
      id: 2,
      title: t('howItWorks.steps.portal.title'),
      description: t('howItWorks.steps.portal.description'),
      icon: <Users className="h-12 w-12 text-vendortal-navy" />,
      features: [
        t('howItWorks.steps.portal.features.secure'),
        t('howItWorks.steps.portal.features.guided'),
        t('howItWorks.steps.portal.features.save'),
        t('howItWorks.steps.portal.features.support')
      ],
      ctaText: t('howItWorks.steps.portal.cta'),
      ctaLink: '/vendor-assessments-demo',
      gradient: 'from-vendortal-navy to-vendortal-purple',
      visualElements: {
    ...
    },
    {
      ...
      icon: <BarChart3 className="h-12 w-12 text-vendortal-purple" />,
      features: [
        t('howItWorks.steps.review.features.scoring'),
        t('howItWorks.steps.review.features.analysis'),
        t('howItWorks.steps.review.features.compliance'),
        t('howItWorks.steps.review.features.recommendations')
      ],
      ctaText: t('howItWorks.steps.review.cta'),
      ctaLink: '/vendor-assessments',
      gradient: 'from-vendortal-purple to-vendortal-light-purple',
      visualElements: {
    ...
    },
    {
      ...
      icon: <Activity className="h-12 w-12 text-vendortal-purple" />,
      features: [
      ...
      gradient: 'from-vendortal-navy to-vendortal-purple',
      visualElements: {
        primary: <Activity className="h-8 w-8" />,
        secondary: <TrendingUp className="h-6 w-6" />,
  ...
  return (
    <main className="min-h-screen py-8 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
            ...
            <div key={step.id} className={`flex flex-col ${index % 2 === 0 ? 'lg:flex-row' : 'lg:flex-row-reverse'} items-center gap-12`}>
              <div className="flex-1">
                <div className="flex items-center mb-6">
                  <div className="w-12 h-12 bg-vendortal-purple/10 rounded-full flex items-center justify-center mr-4">
                    <span className="text-xl font-bold text-vendortal-purple">{step.id}</span>
                  </div>
                ...
                <ul className="space-y-3 mb-6">
                  {step.features.map((feature, featureIndex) => (
                    <li key={featureIndex} className="flex items-start">
                      <CheckCircle className="h-5 w-5 text-vendortal-purple mr-3 mt-0.5 flex-shrink-0" />
      ...
      <section className="mb-16">
        ...
        <div className="bg-gradient-to-r from-vendortal-navy to-vendortal-purple rounded-2xl p-8 text-white relative overflow-hidden">
          {/* Background pattern */}
          ...
          <div className="relative z-10">
            ...
            <div className="text-center mt-8">
              <Link to="/integration-guides">
                <Button variant="secondary" size="lg" className="bg-white text-vendortal-navy hover:bg-gray-100 group">
      ...
      <section className="text-center bg-white dark:bg-gray-800 rounded-2xl p-8 border border-gray-200 dark:border-gray-700 shadow-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="p-6 bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-xl border border-green-200 dark:border-green-700">
            <div className="text-3xl font-bold text-vendortal-purple mb-3 bg-gradient-to-r from-green-600 to-emerald-600 bg-clip-text text-transparent">1</div>
          ...
          <div className="p-6 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-xl border border-blue-200 dark:border-blue-700">
            <div className="text-3xl font-bold text-vendortal-purple mb-3 bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">2</div>
            <h3 className="font-bold text-gray-900 dark:text-white mb-2">
          ...
          <div className="p-6 bg-gradient-to-br from-teal-50 to-cyan-50 dark:from-teal-900/20 dark:to-cyan-900/20 rounded-xl border border-teal-200 dark:border-teal-700">
            <div className="text-3xl font-bold text-vendortal-purple mb-3 bg-gradient-to-r from-teal-600 to-cyan-600 bg-clip-text text-transparent">3</div>
            <h3 className="font-bold text-gray-900 dark:text-white mb-2">
