            ...
            <CardContent className="text-center">
              <div className="mb-6">
                {formData.avatar_url ? (
                  ...
                  <div className="w-32 h-32 rounded-full mx-auto bg-vendortal-navy text-white flex items-center justify-center text-4xl font-bold border-4 border-gray-200 dark:border-gray-700">
