...
const response = await fetch('https://api.vendortal.com/v1/vendors', {
  headers: {
...
app.post('/webhooks/vendortal', (req, res) => {
...
const onboardVendor = async (vendorData) => {
  ...
  return (
    <main className="min-h-screen py-8 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      ...
      {/* Quick Start Section */}
      <Card className="mb-8 border-l-4 border-l-vendortal-purple">
        <CardContent className="p-6">
          <div className="pt-2 flex items-start">
            <div className="w-12 h-12 bg-vendortal-purple/10 rounded-full flex items-center justify-center mr-2">
              <Book className="h-6 w-6 text-vendortal-purple" />
            </div>
            <div className="flex-1">
              ...
              <div className="bg-gradient-to-r from-vendortal-purple/10 to-vendortal-light-purple/10 border border-vendortal-purple/20 dark:border-vendortal-purple/40 rounded-lg p-4 mb-4">
                <h3 className="font-semibold text-gray-900 dark:text-white mb-2">VendorTal Intelligence Suite</h3>
                <p className="text-sm text-gray-700 dark:text-gray-300">
                  Comprehensive vendor risk management: <strong>VendorIQ</strong> (NIST 800-161 C-SCRM assessments), 
                  <strong>Risk Radar</strong> (privacy-focused risk analysis with compliance mapping), and <strong>Threat Intelligence</strong> (automated risk alerts). 
                  Start with a VendorIQ assessment to build your risk profile.
                </p>
              </div>
      ...
      {/* Support Section */}
      <section className="mt-16">
        <Card className="bg-gradient-to-r from-vendortal-navy to-vendortal-purple text-white">
