      ...
      <div className="max-w-2xl w-full">
        <Card className="text-center">
          <CardContent className="p-8">
            {/* 404 Icon */}
            <div className="mb-6">
              <div className="text-8xl font-bold text-vendortal-purple mb-4">404</div>
            ...
            <div className="text-left mb-8">
              ...
              <ul className="space-y-2 text-gray-600 dark:text-gray-400">
                <li className="flex items-center gap-2">
                  <Search className="h-4 w-4 text-vendortal-purple" />
                  {t('errors.checkUrlTypos') || 'Check the URL for typos'}
                </li>
                <li className="flex items-center gap-2">
                  <ArrowLeft className="h-4 w-4 text-vendortal-purple" />
                  {t('errors.goBackPrevious') || 'Go back to the previous page'}
                </li>
                <li className="flex items-center gap-2">
                  <Home className="h-4 w-4 text-vendortal-purple" />
