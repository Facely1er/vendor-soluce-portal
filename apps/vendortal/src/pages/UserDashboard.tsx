      ...
      <div className="mb-8">
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            <div className="w-16 h-16 bg-vendortal-navy rounded-full flex items-center justify-center text-white text-xl font-bold mr-4">
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <Link to="/vendor-risk-dashboard">
                  <div className="p-4 border border-gray-200 dark:border-gray-700 rounded-lg hover:border-vendortal-purple transition-colors cursor-pointer">
                    <div className="flex items-center">
                      <Target className="h-6 w-6 text-vendortal-purple mr-3" />
                      <div>
                ...
                <Link to="/vendor-assessments">
                  <div className="p-4 border border-gray-200 dark:border-gray-700 rounded-lg hover:border-vendortal-purple transition-colors cursor-pointer">
                    <div className="flex items-center">
                      <BarChart3 className="h-6 w-6 text-vendortal-purple mr-3" />
                      <div>
                ...
                <Link to="/sbom-analyzer">
                  <div className="p-4 border border-gray-200 dark:border-gray-700 rounded-lg hover:border-vendortal-purple transition-colors cursor-pointer">
                    <div className="flex items-center">
                      <Shield className="h-6 w-6 text-vendortal-purple mr-3" />
                      <div>
                ...
                <Link to="/templates">
                  <div className="p-4 border border-gray-200 dark:border-gray-700 rounded-lg hover:border-vendortal-purple transition-colors cursor-pointer">
                    <div className="flex items-center">
                      <Calendar className="h-6 w-6 text-vendortal-purple mr-3" />
                      <div>
            ...
            <CardContent>
              <div className="space-y-4">
                ...
                <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                  <div className="bg-vendortal-purple h-2 rounded-full" style={{ width: '85%' }}></div>
                </div>
