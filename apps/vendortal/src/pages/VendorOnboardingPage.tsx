    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              <div className="w-12 h-12 bg-vendortal-purple/10 rounded-lg flex items-center justify-center mr-4">
                <Building className="h-6 w-6 text-vendortal-purple" />
              </div>
              <div>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <div className="w-24 h-24 bg-vendortal-purple/10 rounded-full flex items-center justify-center mx-auto mb-6">
            <Building className="h-12 w-12 text-vendortal-purple" />
          </div>
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              <div className="text-center">
                <div className="w-12 h-12 bg-vendortal-navy text-white rounded-full flex items-center justify-center mx-auto mb-4 text-lg font-bold">
                  1
                </div>
        ...
        {/* CTA Section */}
        <div className="text-center">
          <div className="bg-vendortal-navy rounded-2xl p-8 text-white">
            <h3 className="text-2xl font-bold mb-4">Ready to Get Started?</h3>
            <p className="text-lg mb-6 opacity-90">
              Join thousands of vendors who trust VendorTal for their supply chain security needs.
            </p>
