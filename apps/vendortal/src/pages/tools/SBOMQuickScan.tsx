          ...
          {isLoading ? (
            <Card className="h-64 flex justify-center items-center">
              <div className="text-center">
                <div className="spinner-border mb-3 h-8 w-8 border-b-2 border-t-2 border-vendortal-purple rounded-full animate-spin"></div>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <Link to="/sbom-analyzer">
                  <button className="w-full bg-vendortal-purple hover:bg-vendortal-purple/90 text-white py-2 rounded-md transition">
