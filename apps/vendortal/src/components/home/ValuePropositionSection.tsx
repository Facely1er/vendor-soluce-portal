  ...
  const stakeholders: Stakeholder[] = [
    {
      ...
      solutions: [
        ...
        {
          title: t('home.stakeholders.security.solutions.vendorIQ.title'),
          description: t('home.stakeholders.security.solutions.vendorIQ.description'),
          benefits: [
            t('home.stakeholders.security.solutions.vendorIQ.benefits.assessment'),
            t('home.stakeholders.security.solutions.vendorIQ.benefits.nistMapping'),
            t('home.stakeholders.security.solutions.vendorIQ.benefits.categorization'),
            t('home.stakeholders.security.solutions.vendorIQ.benefits.scoring'),
            t('home.stakeholders.security.solutions.vendorIQ.benefits.compliance')
          ],
          cta: t('home.stakeholders.security.solutions.vendorIQ.cta'),
          link: '/tools/vendor-iq'
        },
        {
          title: t('home.stakeholders.security.solutions.riskMonitoring.title'),
          description: t('home.stakeholders.security.solutions.riskMonitoring.description'),
          benefits: [
            t('home.stakeholders.security.solutions.riskMonitoring.benefits.intelligence'),
            t('home.stakeholders.security.solutions.riskMonitoring.benefits.tracking'),
            t('home.stakeholders.security.solutions.riskMonitoring.benefits.reports'),
            t('home.stakeholders.security.solutions.riskMonitoring.benefits.monitoring')
          ],
          cta: t('home.stakeholders.security.solutions.riskMonitoring.cta'),
          link: '/tools/vendor-risk-radar'
        },
        {
          title: t('home.stakeholders.security.solutions.nistAssessment.title'),
          description: t('home.stakeholders.security.solutions.nistAssessment.description'),
          benefits: [
            t('home.stakeholders.security.solutions.nistAssessment.benefits.framework'),
            t('home.stakeholders.security.solutions.nistAssessment.benefits.assessment'),
            t('home.stakeholders.security.solutions.nistAssessment.benefits.scoring'),
            t('home.stakeholders.security.solutions.nistAssessment.benefits.recommendations'),
            t('home.stakeholders.security.solutions.nistAssessment.benefits.reporting')
          ],
          cta: t('home.stakeholders.security.solutions.nistAssessment.cta'),
          link: '/vendor-assessments'
        }
      ]
    },
    {
      ...
      icon: <Building2 className="h-8 w-8 text-vendortal-navy" />,
      challenges: [
    ...
    },
    {
      ...
      icon: <Lock className="h-8 w-8 text-vendortal-purple" />,
      challenges: [
    ...
    },
    {
      ...
      icon: <Users className="h-8 w-8 text-vendortal-purple" />,
      challenges: [
    ...
    <section className="py-20 px-6 sm:px-8 lg:px-12 bg-gray-50 dark:bg-gray-800">
      <div className="max-w-7xl mx-auto">
            ...
            <button
              ...
              className={`flex items-center px-6 py-3 rounded-lg font-medium transition-all ${
                activeStakeholder === stakeholder.id
                  ? 'bg-vendortal-purple text-white shadow-md'
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2 space-y-8">
            {activeStakeholderData.solutions.map((solution, index) => (
              <Card key={index} className="border-l-4 border-l-vendortal-purple">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    {solution.benefits.map((benefit, benefitIndex) => (
                      <div key={benefitIndex} className="flex items-start">
                        <CheckCircle className="h-4 w-4 text-vendortal-purple mr-3 mt-1 flex-shrink-0" />
        ...
        <div className="mt-12 text-center">
          <div className="bg-gradient-to-r from-vendortal-purple to-vendortal-light-purple rounded-lg p-8 text-white">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Link to="/vendor-assessments">
                <Button variant="secondary" size="lg" className="bg-white text-vendortal-purple hover:bg-gray-100">
