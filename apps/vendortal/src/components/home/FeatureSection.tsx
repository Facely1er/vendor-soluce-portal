...
const FeatureSection: React.FC = () => {
  ...
  const features = [
    ...
    {
      icon: <FileJson className="h-8 w-8 text-vendortal-light-purple" />,
      title: t('home.features.feature2.title'),
      description: t('home.features.feature2.description'),
      path: '/templates'
    },
    {
      icon: <BarChart3 className="h-8 w-8 text-vendortal-purple" />,
      title: t('home.features.feature3.title'),
      description: t('home.features.feature3.description'),
      path: '/vendor-assessments'
    },
    {
      icon: <Zap className="h-8 w-8 text-vendortal-light-purple" />,
          ...
          <div key={index} className="flex flex-col items-center text-center p-6 bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-100 dark:border-gray-700 hover:shadow-lg hover:scale-105 transition-all duration-300 cursor-pointer group">
            ...
            <Link to={feature.path}>
              <Button 
                variant="outline" 
                size="sm"
                className="group-hover:bg-vendortal-purple group-hover:text-white group-hover:border-vendortal-purple transition-all duration-300"
              >
