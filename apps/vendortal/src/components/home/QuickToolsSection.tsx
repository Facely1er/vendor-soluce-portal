...
const QuickToolsSection: React.FC = () => {
  ...
  const getIcon = (iconName: string) => {
    const icons = {
      FileDigit: <FileDigit size={24} className="text-vendortal-light-purple" />,
      Calculator: <Calculator size={24} className="text-vendortal-purple" />,
      CheckSquare: <CheckSquare size={24} className="text-vendortal-purple" />
    };
