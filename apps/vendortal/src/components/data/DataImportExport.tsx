            ...
            <div className="p-6">
              ...
              <div
                className={`border-2 border-dashed rounded-lg p-8 text-center ${
                  dragActive 
                    ? 'border-vendortal-purple bg-vendortal-pale-purple dark:bg-green-900/20' 
              ...
              {isImporting && (
                <div className="mt-4 flex items-center justify-center">
                  <div className="animate-spin rounded-full h-6 w-6 border-b-2 border-vendortal-purple mr-2"></div>
