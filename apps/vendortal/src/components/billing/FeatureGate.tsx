  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center py-8">
        <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-vendortal-purple"></div>
      </div>
    );
  }
  ...
  return (
    <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-8 text-center">
      <div className="flex justify-center mb-4">
        <div className="w-16 h-16 bg-vendortal-pale-purple rounded-full flex items-center justify-center">
          <Lock className="h-8 w-8 text-vendortal-purple" />
        </div>
      </div>
