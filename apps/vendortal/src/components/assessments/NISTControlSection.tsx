    ...
    <section className="py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {nistControls.map((control) => (
          <div key={control.id} className="border border-gray-200 dark:border-gray-700 rounded-md p-4 hover:border-vendortal-navy transition-colors">
            <div className="flex items-start">
              <div className="bg-gray-100 dark:bg-gray-800 text-vendortal-navy dark:text-vendortal-purple font-bold px-3 py-1 rounded text-sm mr-3 mt-1">
                {control.id}
              </div>
              <div>
