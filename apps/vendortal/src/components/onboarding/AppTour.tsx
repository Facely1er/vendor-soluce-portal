...
const AppTour: React.FC<AppTourProps> = ({ isRunning, onComplete, onSkip }) => {
  ...
  const steps: Step[] = [
    {
      ...
      content: (
        <div>
          <h3 className="text-lg font-bold mb-2">Welcome to VendorTal!</h3>
    ...
    },
    {
      ...
      content: (
        <div>
          ...
          <p>Use this menu to navigate between different sections of VendorTal. Access assessments, vendor management, SBOM analysis, and resources.</p>
        </div>
      ),
      placement: 'bottom',
    },
    ...
    },
    {
      ...
      content: (
        <div>
          ...
          <p>This widget shows your progress through essential setup steps. Complete these to get the most out of VendorTal.</p>
        </div>
      ),
      placement: 'bottom',
    },
  ...
  const joyrideStyles = {
    options: {
      primaryColor: '#33691E', // VendorTal green
