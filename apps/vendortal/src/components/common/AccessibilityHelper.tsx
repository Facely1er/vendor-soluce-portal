  ...
  return (
    <>
      ...
      <a
        href="#main-content"
        onClick={skipToMain}
        className="sr-only focus:not-sr-only fixed top-4 left-4 z-50 bg-vendortal-navy text-white px-4 py-2 rounded-md focus:outline-none focus:ring-2 focus:ring-white"
      >
      ...
      <button
        ...
        className="fixed bottom-4 left-4 z-40 bg-vendortal-navy text-white p-3 rounded-full shadow-lg hover:bg-vendortal-dark-purple focus:outline-none focus:ring-2 focus:ring-white"
