  ...
  const htmlContent = `
    <div style="font-family: Arial, sans-serif; max-width: 800px; margin: 0 auto; padding: 20px;">
      ...
      <div style="margin-top: 30px; text-align: center; color: #6B7280; font-size: 12px; border-top: 1px solid #e5e7eb; padding-top: 20px;">
        <p style="margin: 0;">Generated by VendorTal™ Risk Review by ERMITS</p>
        <p style="margin: 5px 0 0 0;">© ${new Date().getFullYear()} VendorTal Risk Review by ERMITS. All rights reserved.</p>
      </div>
    </div>
  `;
...
const generateMockTemplate = (filename: string) => {
  ...
  if (filename.endsWith('.html') || filename.endsWith('.docx')) {
    content = `
      <html>
        <head>
          <title>VendorTal™ Risk Review Template - ${filename}</title>
          <style>
        ...
        <body>
          <h1>VendorTal™ Risk Review Template</h1>
    ...
    content = JSON.stringify({
      template: filename,
      description: "VendorTal™ Risk Review template file",
...
"${filename}","VendorTal™ Risk Review template file","${new Date().toISOString()}"`;
    mimeType = 'text/csv';
  }
    ...
    <html>
      ...
      <body>
        ...
        <div class="content">
          ...
          <p>This is a demonstration template file generated by VendorTal™ Risk Review.</p>
        ...
        <div class="footer">
          <p>Generated by VendorTal™ Risk Review by ERMITS</p>
          <p>© ${new Date().getFullYear()} VendorTal Risk Review by ERMITS. All rights reserved.</p>
        </div>
      </body>
    </html>
  `;
