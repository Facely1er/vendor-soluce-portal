# VendorTal™ Risk Review Deployment Guide
...
VendorTal™ Risk Review uses a modern, scalable deployment architecture with the following components:
...
VITE_APP_NAME=VendorTal Risk Review
```
...
supabase projects create vendortal-risk-review-staging

# Create production project
supabase projects create vendortal-risk-review-production
```
...
```bash
# Add custom domain
vercel domains add vendortal-risk-review.com
vercel domains add www.vendortal-risk-review.com

# Configure DNS
vercel dns add vendortal-risk-review.com A 76.76.19.61
vercel dns add vendortal-risk-review.com CNAME cname.vercel-dns.com
```
...
```bash
# Add custom domain
netlify sites:create --name vendortal-risk-review
netlify domains:add vendortal-risk-review.com
netlify domains:add www.vendortal-risk-review.com
```
...
# A record: vendortal-risk-review.com -> 76.76.19.61
# CNAME: www.vendortal-risk-review.com -> vendortal-risk-review.netlify.app
...
certbot certonly --webroot -w /var/www/html -d vendortal-risk-review.com -d www.vendortal-risk-review.com

# Configure nginx
server {
    listen 443 ssl http2;
    server_name vendortal-risk-review.com www.vendortal-risk-review.com;
    
    ssl_certificate /etc/letsencrypt/live/vendortal-risk-review.com/fullchain.pem;
    ssl_certificate_key /etc/letsencrypt/live/vendortal-risk-review.com/privkey.pem;
  ...
  return {
    ...
    integrations: [
      new Sentry.BrowserTracing({
        tracingOrigins: ['vendortal-risk-review.com', '*.vendortal-risk-review.com'],
      }),
    ],
  };
};
...
# Monitor endpoints:
# - https://vendortal-risk-review.com (main site)
# - https://vendortal-risk-review.com/api/health (health check)
